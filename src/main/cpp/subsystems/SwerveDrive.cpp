...
SwerveDrive::SwerveDrive() {
    ...
    // B = bottom , A = top
    m_rightTopMotor = new CANSparkMax(6, CANSparkMaxLowLevel::MotorType::kBrushless); // A
    m_rightBottomMotor = new CANSparkMax(7, CANSparkMaxLowLevel::MotorType::kBrushless); // B
    // B = bottom , A = top
    m_leftTopMotor = new CANSparkMax(4, CANSparkMaxLowLevel::MotorType::kBrushless); // A
    m_leftBottomMotor = new CANSparkMax(5, CANSparkMaxLowLevel::MotorType::kBrushless); // B
    // right = bottom , left = top
    m_pointTopMotor = new CANSparkMax(3, CANSparkMaxLowLevel::MotorType::kBrushless); // L
    m_pointBottomMotor = new CANSparkMax(2, CANSparkMaxLowLevel::MotorType::kBrushless); // R

    // Individual swerve pod instances
    m_rightPod = new SwervePod(m_rightTopMotor, m_rightBottomMotor, 1.0, 0.0, 0); // 143.706
    m_leftPod = new SwervePod(m_leftTopMotor, m_leftBottomMotor, 1.0, 0.0, 1);   // 164.36
    m_pointPod = new SwervePod(m_pointTopMotor, m_pointBottomMotor, 1.0, 0.0, 2); // 272.912
